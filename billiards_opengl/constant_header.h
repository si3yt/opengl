...
/* floor */
static const GLdouble _FLOOR_WIDTH  = 100.0;
static const GLdouble _FLOOR_HEIGHT = 200.0;

/* hole */
static const GLdouble _HOLE_SIZE = 12.0;

/* wall */
static const GLdouble _WALL_SIZE = 10.0;
static const GLdouble _WALL_TOP_POS[]    = { 0.0, _FLOOR_HEIGHT / 2 + _WALL_SIZE / 2,    0.0 };
static const GLdouble _WALL_BOTTOM_POS[] = { 0.0, -(_FLOOR_HEIGHT / 2 + _WALL_SIZE / 2), 0.0 };
static const GLdouble _WALL_LEFT_POS[]   = { _FLOOR_WIDTH / 2 + _WALL_SIZE / 2,    0.0,  0.0 };
static const GLdouble _WALL_RIGHT_POS[]  = { -(_FLOOR_WIDTH / 2 + _WALL_SIZE / 2), 0.0,  0.0 };
...
static const GLdouble _IN_HOLE_VEC      = 0.1;
static const GLdouble _VEC_THRESHOLD    = 0.05;
